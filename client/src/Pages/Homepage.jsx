...
//             <p className="text-gray-300 mb-4">You have <span className="font-bold text-yellow-400">{excelFiles.length}</span> uploaded Excel files.</p>
//             <Link to="/excel">
...
//   // featured carousel
//   const [index, setIndex] = useState(0);
//   const [showBlogs, setShowBlogs] = useState(false); // for spiral/firework animation
//   const autoplay = useRef(null);
...
//   useEffect(() => {
//     // show normal slider after 2.5s spiral/firework animation
...
//             </h1>
//             <p className="mt-4 text-lg text-gray-300">
//               Read short essays, long-form pieces, and everything in between — curated for curiosity.
//             </p>
...
//         {/* FEATURED CAROUSEL WITH SPIRAL + FIREWORK */}
//         <section>
//           <h2 className="text-2xl font-semibold mb-4">Featured picks</h2>
    ...
    <Layout>
      <div className="pt-10 text-white flex flex-col gap-12 px-6 md:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 bg-gradient-to-r from-zinc-800 to-zinc-900 rounded-2xl p-8 shadow-lg">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight">
              Discover thoughtful writing from <span className="text-yellow-500">real people</span>
            </h1>
            <p className="mt-4 text-lg text-gray-300">
              Read short essays, long-form pieces, and everything in between — curated for curiosity.
            </p>
                    ...
                    >
                        <div className="relative h-full">
                          <div className="absolute top-3 right-3 flex gap-2">
                            {/* AI-picked badge (mock): show when content length is high */}
